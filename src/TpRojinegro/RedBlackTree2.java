...
public class RedBlackTree2<T extends Comparable<T> & Serializable> implements Serializable {
    ...
    public RedBlackTree2(T key) {
        this(new RedBlackTreeNode<>(key));
    }

    private RedBlackTree2(RedBlackTreeNode<T> root) {
...
//    }
    ...
    public RedBlackTree2<T> getLeft() {
        if(isEmpty()) {
    ...
    public RedBlackTree2<T> getRight() {
        if(isEmpty()) {
            throw new RuntimeException("The tree is empty");
        }
